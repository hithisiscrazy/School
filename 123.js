if (!opener){
    ...
    try {
        ...
        opener.window.document.body.innerHTML = "<h1>GoGaurdian Disabled. Restart chromebook to reenabled.</h1> <br/> <h1>This page will close in 5 seconds...</h1> <script>setTimeout(()=>{window.location.href = 'https://google.com'}, 5000)</script>";
        window.close();
